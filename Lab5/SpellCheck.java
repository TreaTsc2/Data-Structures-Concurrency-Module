 ...
 * Modified:
 * Collection used instead of Set for dictionaryWords to allow us experiment
...
// Read the dictionary and the document
        Collection<String> dictionaryWords = readDictionary("C:/Users/T00226097/IdeaProjects/Lab5/src/words.txt");
//Set<String> documentWords = readWords("alice30.txt");
        Set<String> documentWords = readWords("C:/Users/T00226097/IdeaProjects/Lab5/src/war-and-peace.txt"); // file to be
        //spell-checked
...
//System.out.println(word);
        ...
        System.out.println("Number of misspelled words: " + numberMisspeltWords);
    }
